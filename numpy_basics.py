...
# The difference between np.ndarray and np.array is that the former ...
# ... is the actual type, while the latter is a flexible ...
# ... shorthand function  for constructing arrays from data ...
# ... in other formats. The TypeError comes your use of ...
# ... np.array arguments to np.ndarray, which takes completely ...
# ... different arguments (see docstrings)

# Well, numpy.array is just a convenience function to create an ...
